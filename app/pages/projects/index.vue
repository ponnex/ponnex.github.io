<template>
	<div class="projects">
		<header class="page-head shell">
			<div class="page-head__tag">Portfolio</div>
		...
		<div class="shell filter-bar">
			<div class="filter-bar__label">Filter by industry</div>
		...
		<WorkSection section-id="work" group="professional" heading="Client work" :filter="activeFilter" />
		<WorkSection section-id="work-personal" group="personal" heading="Solo work" :filter="activeFilter" />
		<ContactSection />
	</div>
</template>
